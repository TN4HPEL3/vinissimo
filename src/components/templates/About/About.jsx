          ...
          <>
            ...
            <div>
              <p>
                ...
                kieliszek. Trzech sommelierów, kieliszki Riedel – dedykowane do
                różnych szczepów, Coravin. Konwencjonalne, naturalne,
                biodynamiczne. Legendy, friki, klasyka. Wszystko to pozwala nam
                zadbać o każdego: od poczatkującego, dla którego każdy cukier w
                winie jest dobry, po winomana, który wypije do lunchu Colares
                1969. U nas panuje winiarski egalitaryzm i tak samo istotne jest
                dla nas, podstawowe Primitivo jak i Sassicaia, ważne, że i to i
                to sprawia wam przyjemność.
                <br /> <br /> W naszym menu znajdziecie minimalistyczne dania,
                oparte na klasyce z sezonowych produktów. Pracujemy na
                najwyższej jakości składnikach. W karcie znajdziesz: wołowinę
                Wagyu, dorsza Skrei, czarną zimową truflę, świeże ostrygi,
                wieprzowinę Ibérico i wiele innych delikatesów. Wszystkie nasze
                dania są idealne do dzielenia, do czego niezmiennie zachęcamy
                naszych Gości. <br />
                <br />
                Zapraszamy!
              </p>
          ...
          <>
            {screen === 'tablet' && (
              <img
                ...
                alt={'A restaurant wall with a hand that handles dish.'}
              />
            )}
            {screen === 'mobile' && (
              <img
            ...
            <p>
              ...
              Restauracja, prowadzona od 2022 roku przez Łukasza Chwojnickiego,
              w delikatnie zmienionym formacie i z tym samym, niezastąpionym
              teamem, niezmiennie serwuje przepyszną i minimalistyczną kuchnię,
              wspartą ogromną selekcją win i nienagannym serwisem.
            </p>
          </>
        )}
      </div>
